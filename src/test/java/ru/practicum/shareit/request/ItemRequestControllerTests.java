...
public class ItemRequestControllerTests {
    ...
    void create_whenEmptyDescription() {
        int userID = 5;
        IncomeItemRequestDTO incomeDTO = IncomeItemRequestDTO.builder().build();
        ...
        verify(service, never()).addRequest(userID, incomeDTO);
    }
    ...
    void getPageOfItemRequests_exception_whenFromIncorrect() {
        ...
        verify(service, never()).getPageOfOtherUsersRequests(userID, from, size);
